...
/** Mobile-only "Is it just a delay?" self-check. */
export default function MobileDelayChecker() {
  ...
  return (
    <section
      className="md:hidden relative overflow-hidden bg-confident-navy px-5 py-9"
    ...
    >
      ...
      <Reveal className="relative">
        ...
        <h2
          ...
          className="mt-2 font-heading text-[1.6rem] font-extrabold leading-tight text-white"
        >
          Is it just a delay?
        </h2>
        ...
        <div className="mt-4 rounded-[1.25rem] border border-gold/30 bg-white/[0.06] p-4">
          <p
          ...
          <a
            ...
            className="mt-3.5 flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-[#25D366] font-heading text-[0.88rem] font-extrabold text-white"
          >
