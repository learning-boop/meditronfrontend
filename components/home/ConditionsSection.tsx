  ...
  return (
    <>
      <section aria-labelledby="conditions-heading">
        ...
        {conditions.map((condition, index) => {
          ...
          return (
            <div
              key={condition.slug}
              ref={isAdhdRow ? adhdRowRef : undefined}
              className="grid md:grid-cols-2"
            >
              {/* Image */}
              <div
                className={`relative min-h-[300px] md:min-h-[480px] overflow-hidden ${
              ...
              {/* Content */}
              <div
                className={`flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-10 sm:py-14 ${contentBg} ${
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-primary font-bold text-sm sm:text-base hover:gap-3 transition-all group"
                >
                  <ArrowRight
      ...
      {/* ── Online Consultation Popup ─────────────────────────────────
          Slides up when the user reaches the ADHD section.
          Fixed bottom — full-width on mobile, card on desktop.
      ─────────────────────────────────────────────────────────────── */}
      <div
        role="dialog"
        aria-modal="false"
